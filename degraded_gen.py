...
save_folder = os.path.join(opt.data_dir + r"\val_Degradation", 'random')
os.makedirs(save_folder, exist_ok=True)
print('Generating random images. Degraded images will be saved to {} ...'.format(save_folder))
for i, path in enumerate(tqdm(image_list)):
    ...
    text_file_path = os.path.join(save_folder, f"{os.path.splitext(fname)[0]}.txt")
